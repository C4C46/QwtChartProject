...
public slots:
	...
	void onAllCurveNames(const QStringList &allcurveNames);//接收新的所有子类名称
...
private:
	...
	QStringList m_curveNames;//勾选的子类名称
    ...
    QwtPlotMarker *m_alarmMarkerLower;
    QwtPlotMarker *m_alarmMarkerUpper;
};
